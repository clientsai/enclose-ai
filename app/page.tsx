          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/roadmap" className="text-gray-600 hover:text-indigo-600">Roadmap</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-4">Developers</h4>
              <ul className="space-y-2">
                <li><Link href="/docs" className="text-gray-600 hover:text-indigo-600">Documentation</Link></li>
                <li><Link href="/api" className="text-gray-600 hover:text-indigo-600">API Reference</Link></li>
                <li><Link href="/webhooks" className="text-gray-600 hover:text-indigo-600">Webhooks</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/cookies" className="text-gray-600 hover:text-indigo-600">Cookie Policy</Link></li>
                <li><Link href="/compliance" className="text-gray-600 hover:text-indigo-600">Compliance</Link></li>
              </ul>
            </div>
          </div>
